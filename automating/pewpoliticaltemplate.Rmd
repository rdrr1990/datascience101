...
knitr::opts_knit$set(root.dir = '/users/mohanty/Desktop/pewpolitical/')
```
...
Here's a whole bunch more. In each case q21, q22, ... q30 will be weighted and broken down by ideology and then party.
